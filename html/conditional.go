...
// If renders comps when cond is true and nothing otherwise. Call the
// Else method on the result to provide an alternative for the false case.
...
// ForEach renders componentForValue once for each element of values and
// returns the resulting components in order.
