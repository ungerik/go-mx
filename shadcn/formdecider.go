...
// option lists are resolved immediately; option lists that need the
// request context (form:"options=…" registry entries,
// [mx.NamedOptionsContextProvider] types) are collected when the
